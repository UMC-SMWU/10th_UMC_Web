...
- 자신이 원하는 위치에 해당 레포를 클론 받아줍니다 
    ...
    ps. 매주 차마다 쉽게 이어 진행하기 위해 기존 브랜치를 계속해서 분기해나가는 방식으로 진행합니다. 브랜치명은 {깃허브 닉네임/주차 수} 방식으로 쓰시면 됩니다 (gain-0525/week@ 처럼요... ) 반드시 main branch가 아닌 자신이 작업하기로한 branch에서만 작업하셔야 합니다‼️
